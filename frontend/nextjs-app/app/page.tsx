    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <main className="container mx-auto px-4 py-8">
        <SignedOut>
          <div className="text-center py-20">
            ...
            <SignInButton mode="modal">
              <button className="px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition text-lg">
                Get Started
              </button>
            </SignInButton>
          </div>
      ...
      <footer className="border-t bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm mt-20">
        <div className="container mx-auto px-4 py-6 text-center text-sm text-slate-600 dark:text-slate-400">
          ...
          <p className="mt-2">Built with Kafka, FastAPI, Next.js, Convex & Clerk</p>
        </div>
      </footer>
    </div>
  );
